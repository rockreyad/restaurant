...
const Header = () => {
  ...
  return (
    <header className="z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      {/* Desktop and tablet */}
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartNumBg items-center flex justify-center">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "reyad.iubat@gmail.com" && (
                  <Link to={"/createItem"}>
